...
//    }
//    public ResponseEntity<InputStreamResource> getPrescriptionByEmrId(String publicEmrId) throws FileNotFoundException {
//        System.out.println("Calling the database for fetching emr by public id");
//        UUID id = publicPrivateService.privateIdByPublicId(publicEmrId);
...
//
//
//    public ResponseEntity<InputStreamResource> getTestsByEmrId(String publicEmrId) throws FileNotFoundException {
//        System.out.println("Calling the database for fetching emr by public id");
//        UUID id = publicPrivateService.privateIdByPublicId(publicEmrId);
//        String hash = emrRepository.findPrescriptionHash(id);
...
//    }
////
//    public ResponseEntity<InputStreamResource> getCommentsByEmrId(String publicEmrId) throws FileNotFoundException {
//        System.out.println("Calling the database for fetching emr by public id");
//        UUID id = publicPrivateService.privateIdByPublicId(publicEmrId);
